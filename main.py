...
class YoutubeDownloaderApp:
    def __init__(self, root):
        ...
        self.check_button = ttk.Button(self.root, text="Check", command=self.check_url)
        self.check_button.grid(row=0, column=2, padx=5, pady=5)

        self.video_label = ttk.Label(self.root, text="Video Format:")
        ...
        self.video_combo.grid(row=1, column=1, padx=5, pady=5, sticky='w')
        self.video_combo.bind('<<ComboboxSelected>>', self.update_video_info)

        self.audio_label = ttk.Label(self.root, text="Audio Format:")
        ...
        self.audio_combo.grid(row=2, column=1, padx=5, pady=5, sticky='w')
        ...
        self.threads_entry = ttk.Combobox(self.root, state='readonly', width=10, values=[str(i) for i in range(1, 9)])
        self.threads_entry.current(0)
        ...
        self.path_entry = ttk.Entry(self.root, width=45, state='readonly')
        ...
        self.video_details_frame = ttk.LabelFrame(self.details_frame, text="Video details")
        self.video_details_frame.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")
        self.video_details_frame.grid_columnconfigure(1, weight=1)

        self.resolution_label = ttk.Label(self.video_details_frame, text="Resolution:")
        self.resolution_label.grid(row=0, column=0, sticky='e', padx=5, pady=2)
        self.resolution_value = ttk.Label(self.video_details_frame, text="")
        self.resolution_value.grid(row=0, column=1, sticky='w', padx=5, pady=2)

        self.framerate_label = ttk.Label(self.video_details_frame, text="Frame Rate:")
        self.framerate_label.grid(row=1, column=0, sticky='e', padx=5, pady=2)
        self.framerate_value = ttk.Label(self.video_details_frame, text="")
        self.framerate_value.grid(row=1, column=1, sticky='w', padx=5, pady=2)

        self.vsize_label = ttk.Label(self.video_details_frame, text="Size:")
        self.vsize_label.grid(row=2, column=0, sticky='e', padx=5, pady=2)
        self.vsize_value = ttk.Label(self.video_details_frame, text="")
        self.vsize_value.grid(row=2, column=1, sticky='w', padx=5, pady=2)

        self.vbitrate_label = ttk.Label(self.video_details_frame, text="Bitrate:")
        self.vbitrate_label.grid(row=3, column=0, sticky='e', padx=5, pady=2)
        self.vbitrate_value = ttk.Label(self.video_details_frame, text="")
        self.vbitrate_value.grid(row=3, column=1, sticky='w', padx=5, pady=2)

        self.vcodec_label = ttk.Label(self.video_details_frame, text="Codec:")
        self.vcodec_label.grid(row=4, column=0, sticky='e', padx=5, pady=2)
        self.vcodec_value = ttk.Label(self.video_details_frame, text="")
        self.vcodec_value.grid(row=4, column=1, sticky='w', padx=5, pady=2)

        self.audio_details_frame = ttk.LabelFrame(self.details_frame, text="Audio details")
        self.audio_details_frame.grid(row=0, column=1, padx=5, pady=5, sticky="nsew")
        self.audio_details_frame.grid_columnconfigure(1, weight=1)

        self.asize_label = ttk.Label(self.audio_details_frame, text="Size:")
        self.asize_label.grid(row=0, column=0, sticky='e', padx=5, pady=2)
        self.asize_value = ttk.Label(self.audio_details_frame, text="")
        self.asize_value.grid(row=0, column=1, sticky='w', padx=5, pady=2)

        self.abitrate_label = ttk.Label(self.audio_details_frame, text="Bitrate:")
        self.abitrate_label.grid(row=1, column=0, sticky='e', padx=5, pady=2)
        self.abitrate_value = ttk.Label(self.audio_details_frame, text="")
        self.abitrate_value.grid(row=1, column=1, sticky='w', padx=5, pady=2)

        self.acodec_label = ttk.Label(self.audio_details_frame, text="Codec:")
        self.acodec_label.grid(row=2, column=0, sticky='e', padx=5, pady=2)
        self.acodec_value = ttk.Label(self.audio_details_frame, text="")
        ...
        self.duration_value = ttk.Label(self.video_info_frame, text="")
        self.duration_value.grid(row=1, column=1, sticky='w', padx=5, pady=2)

        self.release_label = ttk.Label(self.video_info_frame, text="Release Time:")
        self.release_label.grid(row=2, column=0, sticky='e', padx=5, pady=2)
        self.release_value = ttk.Label(self.video_info_frame, text="")
        self.release_value.grid(row=2, column=1, sticky='w', padx=5, pady=2)

        self.thumbnail_label = ttk.Label(self.video_info_frame, text="Thumbnail:")
